<template>
  <el-card style="margin: 15px; min-height: calc(100vh - 80px)">
    ...
    <!-- 下部-->
    <div style="display: flex;width: 100%;margin-top: 40px;justify-content: center;">
      <!--   左侧 太理通告-->
      <div style="margin-right: 10%">
        <span style="font-size: 22px;display: block;margin-bottom: 30px;margin-left: 10px;">太理通告</span>
        <el-timeline>
      ...
      <!--  右侧-->
      <div style="margin-left: 10%; flex: right">
        <!--   天气组件-->
        <weather/>
        <!--    日历组件-->
