    ...
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div>
            ...
            <div style="float: right;display: inline-flex;">
              <el-tooltip content="导入" placement="top">
                ...
                :on-error="uploadError"
                  action="http://localhost:9099/stu/import/" :limit="1">
                  <el-button icon="Upload" style="width: 50px" type="success"></el-button></el-upload>
              </el-tooltip>
              <el-tooltip content="添加" placement="top">
                <el-button icon="plus" style="width: 50px;margin-left: 30px" type="primary" @click="add"></el-button>
              </el-tooltip>
            </div>
          </div>
        </div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column label="学院" prop="institute" />
          ...
          <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
              ...
              <el-form-item label="学院" prop="institute">
                <el-input v-model="form.institute" style="width: 80%"></el-input>
              </el-form-item>
